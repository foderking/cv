...
\usepackage[]{hyperref}
\hypersetup{
	pdftitle={Ajibola Onaopemipo},
	pdfauthor={Ajibola Onaopemipo},
	pdfsubject={CV for Ajibola Onaopemipo},
...
\begin{minipage}[t][\hmargin][c]{\lcolsize}
	{\huge\textbf{Ajibola Onaopemipo}}\\[1.1em]
	{\Large{Fullstack Web Developer}}
\end{minipage}%
\hfill%
\protect\begin{minipage}[t][\hmargin][c]{\rcolsize}
	...
	\fcolorbox{black}{infoboxcolor}{
		...
		\begin{tabular*}{\linewidth}{r|l}
			...
			{\href{tel:+2349093793212}{{+234}~{909}~{379}~{3212}}}\\
			\large{\emailsymbol{}} &
			{\href{mailto:jomilojuajibola@gmail.com}{{{jomilojuajibola}@gmail.com}}} \\
			\large{\linkedinsymbol{}} &
			{\href{https://www.linkedin.com/in/onaopemipo-ajibola-343869203}{{onaopemipo-ajibola}}} \\
			\large{\githubsymbol{}} &
			{\href{https://github.com/foderking}{{foderking}}} \\
		\end{tabular*}
	}
	\end{adjustbox}
\end{minipage}
